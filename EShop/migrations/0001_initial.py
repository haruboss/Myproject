# Generated by Django 3.1.4 on 2021-03-10 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order_Recived', 'Order_Recived'), ('Order_Processing', 'Order_Processing'), ('On_The_Way', 'On_The_Way'), ('Order_Completed', 'Order_Completed'), ('Order_Canceled', 'Order_Canceled')], max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
