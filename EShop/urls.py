...
urlpatterns = [
    ...
    path('admin-product-detail/<int:pk>/', AdminProductDetailView.as_view(), name='adminproductdetail'),
    path('admin-product-create/', AdminProductCreateView.as_view(), name='adminproductcreate'),
